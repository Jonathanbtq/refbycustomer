 ...
 */
class pdf_propal_refcustomcustomer extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "propal_refcustomcustomer";
		$this->description = $langs->trans('DocModelpropalrefcustomcustomerDescription');
