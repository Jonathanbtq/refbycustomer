 ...
 */
class pdf_facture_refcustomcustomer extends ModelePDFFactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "facture_refcustomcustomer";
		$this->description = $langs->trans('PDFfacturerefcustomcustomerDescription');
