 ...
 */
class pdf_suppinvoice_refcustomcustomer extends ModelePDFSuppliersInvoices
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "suppinvoice_refcustomcustomer";
		$this->description = $langs->trans('SupplierssuppinvoicerefcustomcustomerModel');
