 ...
 */
class pdf_supppropal_refcustomcustomer extends ModelePDFSupplierProposal
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "supppropal_refcustomcustomer";
		$this->description = $langs->trans('DocModelsupppropalrefcustomcustomerDescription');
