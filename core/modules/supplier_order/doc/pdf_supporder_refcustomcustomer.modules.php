 ...
 */
class pdf_supporder_refcustomcustomer extends ModelePDFSuppliersOrders
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "supporder_refcustomcustomer";
		$this->description = $langs->trans('SupplierssupporderrefcustomcustomerModel');
